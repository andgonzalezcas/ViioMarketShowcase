    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          status = 500;
          _context.next = 3;
          return _axios["default"].get('https://dummyjson.com/products?limit=100').then(function (res) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          status = 500;
          _context2.next = 3;
          return _axios["default"].get('https://dummyjson.com/products/' + req.params.productId).then(function (res) {
            response = res.data;
            status = res.status;
          })["catch"](function (error) {
            response = error.message;
